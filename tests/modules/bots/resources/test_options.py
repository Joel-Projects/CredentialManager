...
def test_bots_options_authorized(path, expected_allowed_methods, flask_app_client, regular_user, regularUserBot, adminUserBot):
...
@pytest.mark.parametrize('http_path,expected_allowed_methods', (('/api/v1/bots/', {'GET', 'POST', 'OPTIONS'}),))
