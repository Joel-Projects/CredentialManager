...
def test_sentry_tokens_options_authorized(path, expected_allowed_methods, flask_app_client, regular_user, regularUserSentryToken, adminUserSentryToken):
...
@pytest.mark.parametrize('http_path,expected_allowed_methods', (('/api/v1/sentry_tokens/', {'GET', 'POST', 'OPTIONS'}),))
