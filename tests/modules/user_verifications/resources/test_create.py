...
def test_creating_user_verification(flask_app_client, loginAs, regular_user, regularUserRedditApp):
    response = flask_app_client.post(path, data={'owner_id': regular_user.id, 'reddit_app_id': regularUserRedditApp.id, **data})
