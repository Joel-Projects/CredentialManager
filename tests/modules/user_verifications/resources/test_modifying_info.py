...
def test_modifying_user_verification(flask_app_client, regularUserUserVerification, loginAs):
    ...
    if loginAs.is_admin or loginAs.is_internal:
        ...
        assert403(response, UserVerification, action='patch', internal=True, oldItem=regularUserUserVerification)

def test_modifying_user_verification_by_self(flask_app_client, regularUserInstance, regularUserUserVerification):
