...
def test_user_verifications_options_authorized(path, expected_allowed_methods, flask_app_client, regular_user, regularUserUserVerification, adminUserUserVerification):
...
@pytest.mark.parametrize('http_path,expected_allowed_methods', (('/api/v1/user_verifications/', {'GET', 'POST', 'OPTIONS'}),))
