...
def test_modifying_refresh_token(flask_app_client, regular_user_refresh_token, login_as):
...
@pytest.mark.parametrize("login_as", users, ids=labels)
def test_modifying_refresh_token_update_token(flask_app_client, regular_user_refresh_token, login_as):
    data = [
        {
            "op": "replace",
            "path": "/refresh_token",
...
def test_modifying_refresh_token_by_self(flask_app_client, regular_user_instance, regular_user_refresh_token):
    ...
    assert_success(response, regular_user_instance, RefreshToken, DetailedRefreshTokenSchema)
