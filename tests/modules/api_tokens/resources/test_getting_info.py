...
def test_getting_list_of_api_tokens_owner_id(
    ...
    response = flask_app_client.get(
        path, query_string={"owner_id": regularUserInstance.id}
    )
...
def test_getting_list_of_api_tokens_with_admin(
    flask_app_client, regularUserInstance, adminUserInstance, regularUserApiToken
):
    regularUserApiToken.owner = regularUserInstance
    response = flask_app_client.get(
        path, query_string={"owner_id": regularUserInstance.id}
...
def test_getting_list_of_api_tokens_for_admin_user_with_regular_user(
    flask_app_client, regularUserInstance, admin_user, adminUserApiToken
):
