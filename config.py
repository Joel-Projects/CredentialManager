...
class DevelopmentConfig(BaseConfig):
    ...
    SQLALCHEMY_DATABASE_URI = os.getenv(
        "DATABASE_URI",
        f"postgresql://{BaseConfig.DB_USER}:{BaseConfig.DB_PASSWORD}@{BaseConfig.DB_HOST}:{BaseConfig.DB_PORT}/{BaseConfig.DB_NAME}",
    )
...
class TestingConfig(BaseConfig):
    ...
    SQLALCHEMY_DATABASE_URI = os.getenv(
        "DATABASE_URI",
        f"postgresql://{BaseConfig.DB_USER}:{BaseConfig.DB_PASSWORD}@{BaseConfig.DB_HOST}:{BaseConfig.DB_PORT}/{DB_NAME}",
    )
