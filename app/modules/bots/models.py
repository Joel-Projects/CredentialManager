...
class Bot(db.Model, Timestamp, InfoAttrs, StrName):
    ...
    sentry_token_id = db.Column(db.Integer, db.ForeignKey('credential_store.sentry_tokens.id', **foreignKeyKwargs), info={'label': 'Sentry Token'})
    ...
    database_credential_id = db.Column(db.Integer, db.ForeignKey('credential_store.database_credentials.id', **foreignKeyKwargs), info={'label': 'Database Credential'})
